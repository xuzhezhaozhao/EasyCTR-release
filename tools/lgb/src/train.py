...
class Gold:
    ...
    def build_model(self):
        source_data_train = pd.read_csv(self.root_dir + '/data/data/train.csv', header=None, sep='\t', dtype=cls.dtypes, names=cls.columns)
        source_data_test = pd.read_csv(self.root_dir + '/data/data/test.csv', header=None, sep='\t', dtype=cls.dtypes, names=cls.columns)
    ...
    def save_feature_import(self):
        ...
        feature_importance.to_csv(self.root_dir + '/data/feature/feature_importance.csv', index=False)
